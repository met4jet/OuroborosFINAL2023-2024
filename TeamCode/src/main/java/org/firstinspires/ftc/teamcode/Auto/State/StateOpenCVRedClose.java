...
@TeleOp
public class StateOpenCVRedClose extends LinearOpMode
{
    ...
    public void runOpMode()
    {
        ...
        while (opModeIsActive())
        {
            ...
            telemetry.addData("Middle", SkystoneDeterminationPipeline.avg1);
            telemetry.addData("Right", SkystoneDeterminationPipeline.avg2);
