...
@TeleOp
public class StateOpenCVBlueFar extends LinearOpMode
{
    ...
    public void runOpMode()
    {
        ...
        while (opModeIsActive())
        {
            ...
            telemetry.addData("right", SkystoneDeterminationPipeline.avg1);
    ...
    public static class SkystoneDeterminationPipeline extends OpenCvPipeline
    {
         ...
         */
        static final Point REGION1_TOPLEFT_ANCHOR_POINT = new Point(240,0);
        static final Point REGION2_TOPLEFT_ANCHOR_POINT = new Point(90,0);
        ...
        Point region1_pointB = new Point(
                REGION1_TOPLEFT_ANCHOR_POINT.x + 80,
...
//            region3_Cb = Cb.submat(new Rect(region3_pointA, region3_pointB));
        ...
        public Mat processFrame(Mat input)
        {
            ...
            avg2 = (int) Core.mean(region2_Cb).val[0] + 3;
...
//                    2); // Thickness of the rectangle lines
            ...
            if(Math.abs(Math.abs(avg1) - Math.abs(avg2)) < 3){
