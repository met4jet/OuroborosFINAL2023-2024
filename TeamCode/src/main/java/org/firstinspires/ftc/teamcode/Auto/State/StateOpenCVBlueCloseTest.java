...
@Autonomous(group = "Auto", name = "BlueCloseStateOpenCV")
public class StateOpenCVBlueCloseTest extends LinearOpMode
{
    ...
    public void runOpMode()
    {
        ...
        {
            pos = pipeline.getAnalysis().name();
            telemetry.addData("Analysis", pipeline.getAnalysis().name());
