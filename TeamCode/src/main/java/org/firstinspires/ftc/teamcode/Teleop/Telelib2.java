...
public abstract class Telelib2 extends OpMode {
    ...
    public void arcadeDrive(){
        ...
        if (halfToggle && Math.abs(left_stick_x) > 0.1 ||
            ...
            telemetry.addData("fl pwr", fl.getPower());
            telemetry.addData("bl pwr", bl.getPower());
            telemetry.addData("fr pwr", fr.getPower());
            telemetry.addData("br pwr", br.getPower());
    ...
    public void intake(){
        if(gamepad2.left_trigger > .2) {
            ...
            telemetry.addData("roller pwr", roller.getPower());
        }
